...
<div class="container py-4">
    ...
    <div class="card p-4 shadow-sm">
        ...
        <p>
            <strong>Studio:</strong> {{ $order->jadwal->kelas->studio->studio_name ?? 'Tidak Tersedia' }}<br>
            <strong>Kelas:</strong> {{ $order->jadwal->kelas->kelas_name ?? 'Tidak Tersedia' }}<br>
            <strong>Harga:</strong> Rp {{ number_format($order->jadwal->kelas->kelas_harga ?? 0, 0, ',', '.') }}
        </p>        
