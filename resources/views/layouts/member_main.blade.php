        ...
        <nav id="sidebar" class="bg-white border-end shadow-sm" style="width: 250px; min-height: 100vh;">
            <div class="p-4">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2">
                        <a href="{{ route('member.pesan') }}" class="nav-link text-dark"><i class="bi bi-cart me-2"></i> Pesan</a>
                    </li>
                    <li class="nav-item mb-2">
                        <a href="{{ route('member.saved') }}" class="nav-link text-dark"><i class="bi bi-bookmark me-2"></i> Simpan</a>
                    </li>
                    <li class="nav-item mb-2">
                        <a href="{{ route('member.bantuan') }}" class="nav-link text-dark"><i class="bi bi-question-circle me-2"></i> Bantuan & FAQ</a>
                    </li>
                    <li class="nav-item">
